  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " is updated successfully!"));
          _context.n = 3;
          break;
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alert.showAlert)('error', ((_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || 'Something went very wrong!');
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_51SrewaCx7UKkENneDKV6ChUIURf8zcV9e4Z4A06sl2OSE86sQssEXqYZaSxTMucJBpjObVc8JxRmOppu2f2b9Y1a006HsacdcC');
